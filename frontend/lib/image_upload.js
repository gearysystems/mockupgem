'use strict'
/*
  This endpoint is mostly legacy and was used as proof of concept before we
  came up with the API that revolves around the screenshots/templates resources.
*/
...
const uploadBucket = config.imageUploadBucket;
const maxFileSize = config.maxFileSize;
const imageDownloadURLPrefix = config.processedImagesS3URLPrefix;
